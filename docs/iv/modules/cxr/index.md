...
layout: default
nav_order: 50
description: The CXR module provides lookup tables linking patient identifiers with
  MIMIC-CXR `study_id` and `dicom_id`, allowing analysis of patient chest x-rays to
  be linked with the clinical data from other MIMIC-IV modules.
has_children: true
parent: MIMIC-IV
---
