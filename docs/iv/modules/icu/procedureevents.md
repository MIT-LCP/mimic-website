...
layout: default
nav_order: 10
description: Procedures documented during the ICU stay (e.g. ventilation), though
  not necessarily conducted within the ICU (e.g. x-ray imaging).
parent: ICU
